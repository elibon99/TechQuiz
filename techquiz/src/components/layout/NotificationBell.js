        ...
        <div className={className}>
            <div id="notification-bell" className="notification-bell-inner-container">
                <svg className="notification-bell" xmlns="http://www.w3.org/2000/svg"  aria-hidden="true"
                    ...
                    {ammountOfNotifications ? <circle id="notification-count-circle" className="SVGBadge-svgBackground" cx="26" cy="11" r="9"/> : ""}
                    {ammountOfNotifications ? <text id="notification-count-text" className="SVGBadge-number" x="26" y="14.5" textAnchor="middle">{ammountOfNotifications}</text> : ""}
